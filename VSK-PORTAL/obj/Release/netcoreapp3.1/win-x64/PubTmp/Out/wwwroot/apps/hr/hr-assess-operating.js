    ...
    if (user) {
        ...
        $.List = async function () {
            ...
            const sum_1_2_4 = function () {
                ...
                $('#sum_1_2_4').html((ans_1_2_4_1 + ans_1_2_4_2 + ans_1_2_4_3 + ans_1_2_4_4 + ans_1_2_4_5 + ans_1_2_4_6));
                sum_1_2();
            };
            ...
            $('.1_2_4_5').on('change', function (e) {

                e.preventDefault();

                ans_1_2_4_5 = ($(this).val() / 10) * 3;

                $('#sum_1_2_4_5').html(ans_1_2_4_5);

                sum_1_2_4();

            });

            $('.1_2_4_6').on('change', function (e) {

                e.preventDefault();

                ans_1_2_4_6 = ($(this).val() / 10) * 3;

                $('#sum_1_2_4_6').html(ans_1_2_4_6);
            ...
            $('.custom-select').on('change', function (e) {
                ...
                asse_total_1 = Number($('#s_1_1_1').val()) + Number($('#s_1_1_2').val()) + Number($('#s_1_1_3').val()) +
                    ...
                    Number($('#s_1_2_4_5').val()) + Number($('#s_1_2_4_6').val());

...
let ItemMaster_ImportUpdateData_Update = connect_url + '/v1/ItemMaster_ImportUpdateData_Update';
...
let ItemMaster_ImportUpdateDataTran_Create = connect_url + '/v1/ImportUpdateData_Tran_Create';
        ...
        if (currentindex == 0) {
            ...
            $.each(temp_table, function (key, val) {
                ...
                if (val['record_status'] == 0) {
                    ...
                    if (val['name'] !== null && val['name'] !== '') { name_txt = val['name']; } else { name_txt = '-'; }
                    prefsuppliername_txt = '-';
                    recordstatus_txt = '';
                    //recordstatus_txt = '<span style="color: red;font-weight: bold;text-align: center;">ERROR</span>';

                    console.log("is_error", val['is_error']);

                    if (val['is_error'] > 0) {

                        recordstatus_txt = '<span style="color: red;font-weight: bold;text-align: center;">';

                        if (val['is_c1_error'] == 1) {
                            recordstatus_txt += 'Error-Code A<br>';
                        }
                        if (val['is_c2_error'] == 1) {
                            recordstatus_txt += 'Error-Code B<br>';
                        }
                        if (val['is_c3_error'] == 1) {
                            recordstatus_txt += 'Error-Code C<br>';
                        }
                        if (val['is_c4_error'] == 1) {
                            recordstatus_txt += 'Error-Code D<br>';
                        }
                        if (val['is_c5_error'] == 1) {
                            recordstatus_txt += 'Error-Code E<br>';
                        }
                        if (val['is_itemname_error'] == 1) {
                            recordstatus_txt += 'Error-Item name<br>';
                        }
                ...
                if (val['grvat'] == null) { var val_grvat = ''; } else { var val_grvat = val['grvat']; }

                if (val['itemname'] == null) { var val_itemname = ''; } else { var val_itemname = val['itemname']; }

                if (val['code_a'] == null || val['code_a'] == 'eeee') { var val_code_a = ''; } else if (val['code_a'] == 'nnnn') {
                    var val_code_a = "<span style='color: red;font-weight: bold;text-align: center;'>NOT FOUND</span>";
                } else { var val_code_a = val['code_a']; }
                ...
                if (val['code_b'] == null || val['code_b'] == 'eeee') { var val_code_b = ''; } else if (val['code_b'] == 'nnnn') { var val_code_b = "<span style='color: red;font-weight: bold;text-align: center;'>NOT FOUND</span>"; } else { var val_code_b = val['code_b']; }
                if (val['gmodel'] == null) { var val_gmodel = ''; } else { var val_gmodel = val['gmodel']; }

                if (val['code_c'] == null || val['code_c'] == 'eeee') { var val_code_c = ''; } else if (val['code_c'] == 'nnnn') { var val_code_c = "<span style='color: red;font-weight: bold;text-align: center;'>NOT FOUND</span>"; } else { var val_code_c = val['code_c']; }
                if (val['type'] == null) { var val_type = ''; } else { var val_type = val['type']; }

                if (val['code_d'] == null || val['code_d'] == 'eee') { var val_code_d = ''; } else if (val['code_d'] == 'nnn') { var val_code_d = "<span style='color: red;font-weight: bold;text-align: center;'>NOT FOUND</span>"; } else { var val_code_d = val['code_d']; }
                if (val['gused'] == null) { var val_gused = ''; } else { var val_gused = val['gused']; }

                if (val['code_e'] == null || val['code_e'] == 'eeee') { var val_code_e = ''; } else if (val['code_e'] == 'nnnn') { var val_code_e = "<span style='color: red;font-weight: bold;text-align: center;'>NOT FOUND</span>"; } else { var val_code_e = val['code_e']; }
                ...
                $('#tbl-list-temp tbody').append('<tr>' +
                    ...
                    '<td class="tx-center">' + val_stdmargin + '</td>' +
                    '<td class="tx-center">' + val_grvat + '</td>' +
                    '<td>' + val_itemname + '</td>' +

...
const url_brtra_update = url_api + '/api/Br_Brtra_Update';
const url_brtra_get = url_api + '/api/Br_Brtra_Get';
const url_brtra_job = url_api + '/api/Br_Brtra_Job';
...
firebase.auth().onAuthStateChanged(function (user) {
    ...
    if (user) {
        ...
        $.init = async function () {
            ...
            if (urlParams.get('brtra_number') != null) {

                $('#frm_job').find('#brtra_number').val(urlParams.get('brtra_number')).focus();
                $("#global-loader").fadeIn("slow");
                fetch(url_brtra_job + '?brtra_number=' + urlParams.get('brtra_number') + '&created_by=' + name).then(function (response) {
                    ...
                    if (result.length > 0) {
                        ...
                        $('#frm_job').find('#brtra_number').prop('disabled', true);
                        $('#frm_job').find('.hideny').show();
                        $('#empname').val(result.data[0]['empname']);
        ...
        $.Create = async function () {
            ...
            $('#frm_job').find('#brtra_number').focus().keyup(async function (e) {
                ...
                if ($(this).val().length === 12) {
                    ...
                    if (e.keyCode == 13) {
                        ...
                        fetch(url_brtra_job + '?brtra_number=' + $(this).val() + '&created_by=' + name).then(function (response) {
            ...
            $('#frm_job').find('#gbarcode').focus().keyup(async function (e) {
                ...
                if ($(this).val().length >= 3) {
                    ...
                    if (e.keyCode == 13) {
                        ...
                        let update_data = {
                            br_job_no: $('#frm_job').find('#brtra_number').val(),
                            gbarcode: gbarcode,
                        ...
                        fetch(url_brtra_update, {
                            ...
                            if (result.status === 'Error') {
                                ...
                                if ((result.data[0]['pMessage']) != null) {
                                    ...
                                    oTable = $('#tbl-list').DataTable({ "order": [[1, "asc"]], "pageLength": 100 });

    ...
    if (user) {
        ...
        $.init = function () {
            ...
            $.fntemptable = function (currentindex) {
                ...
                let url = 'http://192.168.1.159/ReportServer/Pages/ReportViewer.aspx?%2fReport-Template-Stmas-Exp%2fError-Stmas-Exp&rs:Command=Render&temp_id=' + temp_id + '&rs:Format=excel';
                ...
                if (currentindex == 0) {
                    ...
                    $.each(temp_table, function (key, val) {
                        ...
                        if (val['TYPE'] == null) { var val_TYPE = ''; } else { var val_TYPE = val['TYPE']; }
                        if (val['GUSED'] == null) { var val_GUSED = ''; } else { var val_GUSED = val['GUSED']; }
                        ...
                        if (val['gnamechr'] == null) { var val_gnamechr = ''; } else { var val_gnamechr = val['gnamechr']; }
                        ...
                        if (action_type == 'create') {
                            ...
                            code1 = val_code_a.trim().length !== 6 || val['record_status'] == 11 ? '<span style="color:red ;font-weight: bold;text-align: center;">' + '??????' + '</span>' : val_code_a
                            code2 = val_code_b.trim().length !== 4 || val['record_status'] == 12 ? '<span style="color:red ;font-weight: bold;text-align: center;">' + '????' + '</span>' : val_code_b
                            code3 = val_code_c.trim().length !== 4 || val['record_status'] == 13 ? '<span style="color:red ;font-weight: bold;text-align: center;">' + '????' + '</span>' : val_code_c
                            code4 = val_code_d.trim().length !== 3 || val['record_status'] == 14 ? '<span style="color:red ;font-weight: bold;text-align: center;">' + '???' + '</span>' : val_code_d
                            code5 = val_code_e.trim().length !== 4 || val['record_status'] == 15 ? '<span style="color:red ;font-weight: bold;text-align: center;">' + '????' + '</span>' : val_code_e
                            ...
                            if (val['record_status'] == 0) {
                                ...
                                status_txt = '<span style="color: #414241 ;font-weight: bold;text-align: center;">มีข้อมูลซ้ำในเอกสาร</span>';
                            } else if (val['record_status'] == 3) {
                                val_stmas_name = '<span style="color: #414241 ;font-weight: bold;text-align: center;">ไม่พบข้อมูล</span>';
                                name_txt = '<span style="color: #414241 ;font-weight: bold;text-align: center;">ไม่พบข้อมูล</span>';
                                recordstatus_txt = '<span style="color: red;font-weight: bold;text-align: center;">ERROR</span>';
                            ...
                            } else if (val['record_status'] == 10) {
                                name_txt = val['name'];
                                code = '<span style="color: red;font-weight: bold;text-align: center;">' + code1 + '-' + code2 + '-' + code3 + '-' + code4 + '-' + code5 + '</span>';
                                recordstatus_txt = '<span style="color: orange;font-weight: bold;text-align: center;">DUPLICATE</span>';
                                status_txt = '<span style="color: #414241 ;font-weight: bold;text-align: center;">รหัสและชื่อพ่วงสินค้าซ้ำ</span>';
                            ...
                            if (status == 1) {
                                ...
                                bg_row = '#FFC0CB';
                            } else if (status == 2 || status == 4 || status == 5 || status == 10) {
                                bg_row = '#FFFFCC';
                            }
                    ...
                    $.each(temp_table, function (key, val) {
                        ...
                        if (action_type == 'create') {
                            ...
                            if (val['record_status'] == 1) {
                                name_txt = val['name'];
                                status_txt = '<span style="color: green; font-weight: bold;text-align: center;">สามารถนำเข้าได้</span>';
                                results = '<span style="color: green; font-weight: bold;text-align: center;">สามารถนำเข้าได้</span>';
                                ...
                                results = '<span style="color: red; font-weight: bold;text-align: center;">ไม่สามารถนำเข้าได้</span>';
                            ...
                            if (val['record_status'] == 1) {
                                name_txt = val['name'];
                                status_txt = '<span style="color: green; font-weight: bold;text-align: center;">สามารถแก้ไขรายการได้</span>';
                                results = '<span style="color: green; font-weight: bold;text-align: center;">สามารถแก้ไขรายการได้</span>';
                                recordstatus_txt = '<span style="color: green;font-weight: bold;text-align: center;"><i class="fa fa-check"></i></span>';
                            } else {
                                name_txt = val['name'];
                                status_txt = '<span style="color: red; font-weight: bold;text-align: center;">ไม่สามารถแก้ไขรายการได้</span>';
                                results = '<span style="color: red; font-weight: bold;text-align: center;">ไม่สามารถลแก้ไขรายการได้</span>';
                                recordstatus_txt = '<span style="color: red;font-weight: bold;text-align: center;"><i class="fas fa-times"></i></span>';
                            }
                            ...
                            if (val['record_status'] == 1) {
                                ...
                                results = '<span style="color: green; font-weight: bold;text-align: center;">สามารถลบรายการได้</span>';
                                recordstatus_txt = '<span style="color: green;font-weight: bold;text-align: center;"><i class="fa fa-check"></i></span>';
                            } else {
                                name_txt = val['name'];
                                status_txt = '<span style="color: red; font-weight: bold;text-align: center;">ไม่สามารถลบรายการได้</span>';
                                results = '<span style="color: red; font-weight: bold;text-align: center;">ไม่สามารถลบรายการได้</span>';
                                recordstatus_txt = '<span style="color: red;font-weight: bold;text-align: center;"><i class="fas fa-times"></i></span>';
                            }
                        ...
                        $('#tbl-list-temp-1 tbody').append('<tr style="background-color:;">' +
                            '<td class="tx-center">' + i + '</td>' +
                            '<td class="tx-center">' + recordstatus_txt + '</td>' +
                            '<td class="tx-center style="width: 150px;"">' + status_txt + '</td>' +
                            '<td class="tx-center" style="width: 150px;">' + val_coderef + '</td>' +
                ...
                onStepChanged: function () {
                    ...
                    if (chk_index == 2) {
                        ...
                        Swal.fire({
                            ...
                            text: "ที่จะทำการอัพโหลดรายการสินค้า",
                            icon: 'warning',
                            showDenyButton: true,
            ...
            $('#wizards').find('#btn_downloadtemplate').on('click', function (evt) {
                ...
                location.href = template_url + 'Import_Data_StmasExp-UAT_.xlsx';
                                        ...
                                        success: function (data) {
                                            ...
                                            if (data.status != 'Success') {
                                                ...
                                                fetch(url_import_data_template_get + '?temp_id=' + temp_id + '&created_by=' + name + '&created_by2=' + full_name).then(function (response) {
                                                    ...
                                                    console.log("action_type", result.data[0]['action_type']);

                                                    let mode = result.data[0]['action_type'];

                                                    if (mode == 'create') {
                                                        $('.container').find('.breadcrumb-header').append('<div class="d-flex my-xl-auto right-content"><div class= "mb-3 mb-xl-0" ><h4 style="color: MediumSeaGreen;">CREATE</h4></div ></div >');
                                                    } else if (mode == 'update') {
                                                        $('.container').find('.breadcrumb-header').append('<div class="d-flex my-xl-auto right-content"><div class= "mb-3 mb-xl-0" ><h4 style="color: Tomato;">UPDATE</h4></div ></div >');
                                                    } else if (mode == 'delete') {
                                                        $('.container').find('.breadcrumb-header').append('<div class="d-flex my-xl-auto right-content"><div class= "mb-3 mb-xl-0" ><h4 style="color: red;">DELETE</h4></div ></div >');
                                                    } else {

                                                    }
                                                    //$('.container').find('.breadcrumb-header').append('<div class="d-flex my-xl-auto right-content"><div class= "mb-3 mb-xl-0" ><h4 style="color: drakgreen;">CREATE</h4></div ></div >');
                                                    //$('.container').find('.breadcrumb-header').append('<div class="d-flex my-xl-auto right-content"><div class= "mb-3 mb-xl-0" ><h4 style="color: yellow;">UPDATE</h4></div ></div >');
                                                    //$('.container').find('.breadcrumb-header').append('<div class="d-flex my-xl-auto right-content"><div class= "mb-3 mb-xl-0" ><h4 style="color: drakgreen;">DELETE</h4></div ></div >');
                                                    ...
                                                    $.each(result.data, function (key, val) {
                                                        ...
                                                        if (action_type == 'create') {
                                                            ...
                                                            if (val['record_status'] == 0) {
                                                                name_txt = val['name'];
                                                                recordstatus_txt = '<span style="color:red ;font-weight: bold;text-align: center;">ERROR</span>';
                                                                status_txt = '<span style="color: #414241 ;font-weight: bold;text-align: center;">ERROR</span>';
                                                            } else if (val['record_status'] == 1) {
                                                                name_txt = val['name'];
                                                                recordstatus_txt = '<span style="color: green;font-weight: bold;text-align: center;">OK</span>';
                                                                status_txt = '<span style="color: green; font-weight: bold;text-align: center;">สามารถแก้ไขได้</span>';
                                                            } else if (val['record_status'] == 2) {
                                                                name_txt = val['name'];
                                                                recordstatus_txt = '<span style="color: orange;font-weight: bold;text-align: center;">DUPLICATE</span>';
                                                                status_txt = '<span style="color: #414241 ;font-weight: bold;text-align: center;">มีข้อมูลซ้ำในเอกสาร</span>';
                                                            ...
                                                            if (status == 1) {
                                                                bg_row = '#66FF99';
                                                            } else if (status == 0 || status == 3 || status == 11 || status == 12 || status == 13 || status == 14 || status == 15) {
                                                                bg_row = '#FFC0CB';
                                                            ...
                                                            if (val['record_status'] == 0) {
                                                                ...
                                                                recordstatus_txt = '<span style="color: orange;font-weight: bold;text-align: center;">DUPLICATE</span>';
                                                                status_txt = '<span style="color: #414241 ;font-weight: bold;text-align: center;">มีข้อมูลซ้ำในเอกสาร</span>';
                                                            } else if (val['record_status'] == 16) {
                                                                name_txt = val['name'];
                                                                recordstatus_txt = '<span style="color:red ;font-weight: bold;text-align: center;">ERROR</span>';
                                                                status_txt = '<span style="color: #414241 ;font-weight: bold;text-align: center;">ไม่พบรายการสินค้าพ่วง</span>';
                                                            }

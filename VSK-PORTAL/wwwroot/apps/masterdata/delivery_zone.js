...
let Create_Delivery_Zone = url_api_new + 'v1/Create_Delivery_Zone';
let Delivery_Zone_Check = url_api_new + 'v1/Delivery_Zone_Check';
let Delivery_Zone_Get = url_api_new + 'v1/Delivery_Zone_Get';
let Delivery_Zone_Update = url_api_new + 'v1/Delivery_Zone_Update';
let Delivery_Zone_Delete = url_api_new + 'v1/Delivery_Zone_Delete';
let route_dataSet = [];
let zone_dataSet = [];
...
$.init = function () {
    ...
    $(".clear_btn").on("click", function () {
        ...
        setTimeout(function () {
            $('#zone_search').append($("<option value=''>Please select..</option>").val(''));
            $('#route_search').append($("<option value=''>Please select..</option>").val(''));
            $.Zone_Get('Search');
        }, 1000);
                ...
                if (data.status === 'Error') {
                    ...
                    toastr.success('Save Successfully!', async function () {
                        ...
                        if (submit_action === "save_exit") {
                            ...
                            //$("#zone_search").empty();
                            setTimeout(function () {
                                $('#zone').append($("<option value=''>Please select..</option>").val(''));
                                $('#zone_search').append($("<option value=''>Please select..</option>").val(''));
                                $.Zone_Get('Search');
                            }, 800);
                            $.List();

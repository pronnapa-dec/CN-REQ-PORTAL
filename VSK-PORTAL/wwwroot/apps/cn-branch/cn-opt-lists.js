            ...
            oTable = $('#tbl-list').DataTable({
                ...
                columns: [
...

                    {
                        ...
                        render: function (data, type, row, meta) {
                            console.log(data)
                            return data != '' ? data != null ? data != '0001-01-01T00:00:00' ? data != '1900-01-01T00:00:00' ? '<span style="font-size:11px;">' + moment(data, 'YYYY-MM-DD hh:mm:ss').format('DD/MM/YYYY hh:mm:ss') + '<span/>' : '-' : '-' : '-' : '-';
                        }
                    }, //5
                ...
                "initComplete": function (settings, json) {
                    ...
                    $("tbody").contextmenu(function (key) {
                        setTimeout(function () {
                            ...
                            if (user_id === 'ongkarn.s' || user_id === 'potjana.s' || user_id === 'kullanut.d') {
...
$.Edit = async function (citem) {
    ...
    if (user_id === 'ongkarn.s' || user_id === 'pronnapa.d' || user_id === 'potjana.s' || user_id === 'kullanut.d') {

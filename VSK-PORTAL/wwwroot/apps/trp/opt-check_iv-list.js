...
firebase.auth().onAuthStateChanged(async function (user) {
    ...
    if (user) {
        ...
        $.init = async function () {
            ...
            $('#job_inv_date').prop('disabled', false);

            $('#job_inv_date').daterangepicker({
                locale: {
                    format: 'DD/MM/YYYY'
                },
                ranges: {
        ...
        $.List = async function () {
            ...
            url.search = new URLSearchParams({
                ...
                jobdate_start: trndate_start,
                jobdate_end: trndate_end,
                    ...
                    tbl_list = $('#tbl-list').DataTable({
                        ...
                        columns: [
                            ...
                            }, //11
                            {
                                ...
                                //visible: false,
                                render: function (data, type, row, meta) {
                                    return '<span style="font-size:11px;">' + data + '<br>' + moment(row.created_date).format("DD/MM/YYYY HH:ss:mm") + '</span>';
                                }
                            }, //12
                            {
